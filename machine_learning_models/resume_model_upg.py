# -*- coding: utf-8 -*-
"""resume_model_(2) (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rmfcB9hmZ2AMiHQ0OflAn3RzNL14Gh-2
"""
...
best_frt = best_rf.fit(X_train, y_train)

best_frt_pred = best_frt.predict(X_test)

mse = mean_squared_error(y_test, best_frt_pred)
r2 = r2_score(y_test, best_frt_pred)
...
joblib.dump(best_frt, 'models/resume_matcher_random_forest.pkl')

plt.scatter(y_test, best_frt_pred, alpha=0.6)
plt.xlabel("Actual Match Score")
plt.ylabel("Predicted Match Score")
plt.title("True vs. Predicted Match Scores")
plt.plot([0, 100], [0, 100], 'r--')
